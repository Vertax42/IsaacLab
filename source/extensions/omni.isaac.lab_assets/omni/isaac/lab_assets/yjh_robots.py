...
XBot_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.path.expanduser("~/usd_file/XBot-L/XBot-L.usd"),
...
XBot_All_Joints_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.path.expanduser("~/usd_file/XBot-L/XBot-L-all-joints.usd"),
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
XBot_All_Joints_waist_yaw_joint_fixed_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=os.path.expanduser("~/usd_file/XBot-L/XBot-L-all-fixed-joints-waist_yaw_joint.usd"),
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
